...
export function renderCard(item, idx) {
  ...
  return `<div class="card-wrap rounded-xl overflow-hidden bg-white border-2 border-transparent cursor-pointer transition-all hover:shadow-lg hover:border-gray-100" data-idx="${idx}" data-url="${escA(item.url || '')}" ${areaAttr}>
    ${imgHtml}
